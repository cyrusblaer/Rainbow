...
public func uploadImg(urlString :String,
                           params:[String:AnyObject]?,
                           imgs: [UIImage],
                           success :@escaping (_ response : [String : AnyObject])->(),
                           progressClosure :@escaping (_ progress : Double)->(),
                           failure : @escaping (_ error : Error)->()) {
    return UploadManager.default.uploadImg(urlString: urlString, params: params, imgs: imgs, success: success, progressClosure: progressClosure, failure: failure)
}
