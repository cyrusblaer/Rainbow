...
class DownloadManager {
    ...
    func cancel(_ url: String, parameters: Parameters?, dynamicParams: Parameters? = nil) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name("DownloadCancel"), object: nil)
    }
...
public class DownloadTaskManager {
    ...
    init(_ url: String,
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(downloadCancel), name: NSNotification.Name.init("DownloadCancel"), object: nil)
